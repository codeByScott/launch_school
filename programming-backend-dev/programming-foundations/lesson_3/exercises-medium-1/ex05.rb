...
# asked Alan to change the loop. How can you change the loop construct (instead of using begin/end/until) to 
# make this work? Note that we're not looking to find the factors for 0 or negative numbers, 
